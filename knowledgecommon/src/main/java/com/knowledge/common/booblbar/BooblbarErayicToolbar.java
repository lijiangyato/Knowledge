package com.knowledge.common.booblbar;
 ...
 * 作用: Toolbar居中问题
 */
public class BooblbarErayicToolbar extends Toolbar {
    ...
    public BooblbarErayicToolbar(Context context) {
        super(context);
        resolveAttribute(context, null, R.attr.toolbarStyle);
    }

    public BooblbarErayicToolbar(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        resolveAttribute(context, attrs, R.attr.toolbarStyle);
    }

    public BooblbarErayicToolbar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
